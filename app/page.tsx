...
export default function Home() {
  return (
    <>
      <div
        className={`flex relative items-center text-center min-h-[600px] absolute  top-0 left-0 right-0 bg-cover bg-center bg-[url('/assets/home/mobile/image-header.jpg')]`}
      >
