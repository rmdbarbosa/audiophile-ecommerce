  ...
  return (
    <div className="bg-black absolute left-0 right-0 mt-24 gap-8 text-center flex flex-col justify-center items-center max-w-[375px] p-8">
      <div>
        ...
        <div className="border border-orange-400 top-0 left-[9rem] absolute left-125 min-w-[80px]"></div>
      </div>
      <ul className="flex flex-col text-white text-sm gap-6 tracking-widest">
        {links.map((link) => (
          <li
            key={link}
      ...
      <p className="normal-case text-gray-400 text-sm mt-6 p-3">
        Audiophile is an all in one stop to fulfill your audio needs. We are a
        small team of music lovers and sound specialists who are devoted to
        helping you get the most out of personal audio. Come and visit our demo
        facility - we’re open 7 days a week.
      </p>
      <span className="normal-case text-gray-400 text-sm mt-6 p-3">
